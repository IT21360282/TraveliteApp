...
class HotelAddMealFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_add_meal, container, false)
        ...
        btnSubmitMeal.setOnClickListener {
            ...
            if(mealID.isNotEmpty()) {
                databaseReferenceMeal =
                    FirebaseDatabase.getInstance().getReference("hotel/$username/hotelMeals")
