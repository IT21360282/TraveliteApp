...
class HotelMealDisplayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hotel_meal_display, container, false)
        ...
        val usersRef = database.getReference("hotel/$username/hotelMeals")
    ...
    private fun deleteMeal(mealID: String, userName: String) {
        databaseReference = FirebaseDatabase.getInstance().getReference("hotel/$userName/hotelMeals")
        databaseReference.child(mealID).removeValue().addOnSuccessListener {
            ...
            val allMealFragment = HotelMealDisplayFragment()
